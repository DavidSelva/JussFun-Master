package com.app.jussfun.external.qrscannner;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        RelativeLayout relativeLayout = (RelativeLayout) inflater.inflate(R.layout.layout_qr_scanner, this);
        ...
        mFrameRect.left = (displayMetrics.widthPixels - layoutParams.width) / 2;
        mFrameRect.top = (int) ((displayMetrics.heightPixels - layoutParams.height) / 3);
...
//        drawText(canvas, frame);
    ...
    private void drawText(Canvas canvas, Rect rect) {
        ...
        float left = (displayMetrics.widthPixels - (mPaint.getTextSize()) * text.length()) / 2;
        /*
