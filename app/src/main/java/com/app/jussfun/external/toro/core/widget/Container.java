...
package com.app.jussfun.external.toro.core.widget;
...
import com.app.jussfun.external.toro.core.PlayerDispatcher;
import com.app.jussfun.external.toro.core.PlayerSelector;
import com.app.jussfun.external.toro.core.ToroPlayer;
import com.app.jussfun.external.toro.core.annotations.RemoveIn;
...
import static com.app.jussfun.external.toro.core.ToroUtil.checkNotNull;
import static com.app.jussfun.external.toro.core.widget.Common.max;
...
public class Container extends RecyclerView {
    ...
    public SparseArray<PlaybackInfo> getLatestPlaybackInfos() {
        ...
        List<ToroPlayer> activePlayers = this.filterBy(Filter.PLAYING);
    ...
    private static class RecyclerListenerImpl implements RecyclerListener {
