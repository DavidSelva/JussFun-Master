package com.app.jussfun.external.qrgenerator;
...
public class QRGEncoder {
    ...
    public Bitmap getBitmap() {
        ...
        try {
            ...
            AppUtils appUtils = new AppUtils(App.getInstance());
            String encoding = appUtils.guessAppropriateEncoding(contents);
            if (encoding != null) {
                hints = new EnumMap<>(EncodeHintType.class);
                hints.put(EncodeHintType.CHARACTER_SET, encoding);
            }
            MultiFormatWriter writer = new MultiFormatWriter();
            BitMatrix result = new QRCodeWriter().encode(contents, BarcodeFormat.QR_CODE, dimension, dimension, hints);
