...
public class NearByActivity extends BaseFragmentActivity implements CardStackListener, SlidrListener {
...
//        cardManager.setStackFrom(StackFrom.None);
        ...
        initFilterDialog(NearByActivity.this, 0, 0);
...
//                showMatchDialog(nearByUsersList.get(lastUserPosition));
    ...
    private void initFilterDialog(Context context, int x, int y) {
        ...
        locationLay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent locationIntent = new Intent(getApplicationContext(), LocationFilterActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnFilter:
                ...
                showFilterDialog(getApplicationContext());
                break;
            case R.id.btnRetry:
                offset = 0;
                getNearByUsersList();
    ...
    public class CardStackAdapter extends RecyclerView.Adapter<CardStackAdapter.MyViewHolder> {
        ...
        private Context context;
        private CardStackAdapter.MyViewHolder viewHolder;
        ...
        public CardStackAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            viewHolder = new CardStackAdapter.MyViewHolder(itemView);
        ...
        public void onBindViewHolder(@NonNull CardStackAdapter.MyViewHolder holder, int position) {
            ...
            if (follower.getPremiumMember().equals(Constants.TAG_TRUE)) {
                ((CardStackAdapter.MyViewHolder) holder).premiumImage.setVisibility(View.VISIBLE);
            } else {
                ((CardStackAdapter.MyViewHolder) holder).premiumImage.setVisibility(View.GONE);
            }
            ...
            ((CardStackAdapter.MyViewHolder) holder).txtLocation.setText(AppUtils.formatWord(follower.getLocation()));
            ...
            Glide.with(context)
                    ...
                    .into(((CardStackAdapter.MyViewHolder) holder).userImage);
