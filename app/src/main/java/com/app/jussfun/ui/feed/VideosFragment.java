...
public class VideosFragment extends Fragment implements OnMenuClickListener {
    ...
    private VideosFragment feedsFragment;
    ...
    public static Fragment newInstance(String s, String s2) {
